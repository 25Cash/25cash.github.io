...
?>
<?php 
$use = "SELECT ot_id FROM donations ORDER BY ot_id";
$result = mysqli_query($con,$use);
$raw = mysqli_num_rows($result);
?>
<?php 
$use = "SELECT d_id FROM donors ORDER BY d_id";
$result = mysqli_query($con,$use);
    ...
    <div class="main">
        ...
        <div class="center">
            ...
            <div class="content">
                ...
                <div class="card">
                    <span>Total Donors&nbsp;<p>(<?php echo $ruw?>)</p></span>
                    
                </div>
                <div class="card">
                    <span>Total Donations&nbsp;<p>(<?php echo $raw?>)</p></span>
