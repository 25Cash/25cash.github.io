...
<div class="main">
        ...
        <div class="btn">
            ...
            <table border="0" cellpadding="10" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><a href="donation_update.php?mod=<?php echo $row['ot_id']?>" class="upd">Update</a></td>
                    <td><a href="donations.php?mod=<?php echo $row['ot_id']?>" class="del">Delete</a></td>
                </tr>
                <?php 
                }
                ?>
        ...
        if (isset($_GET['mod'])) {
            $view = $_GET['mod'];
            $delete = "DELETE FROM donations WHERE ot_id='$view'";
